    ...
    <div className='h-screen pt-24 w-full' id='Skills'>
      <div>
        ...
        <div className='grid grid-col-1 gap-6 justify-center md:flex md:gap-10'>
          <div className='h-60 border-gray-600 border-2  w-80 rounded-xl md:w-[500px] md:h-[400px]'>
            <h3 className='flex justify-center mt-4 font-bold text-[#ca2c92] font-mydesc md:text-4xl'>Technical Skills</h3>
          ...
          <div className='h-60 border-gray-600 border-2 w-80 rounded-xl md:w-[500px] md:h-[400px]'>
          <h3 className='flex justify-center mt-4 font-bold text-[#ca2c92] font-mydesc md:text-4xl'>Professional Skills</h3>
          <ol className='m-4 font-semibold font-myname text-gray-300 text-[14px] md:text-2xl'>
