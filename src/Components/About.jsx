  ...
  return (
    <div className='h-screen py-[120px]' id='About'>
        ...
        <div className='grid grid-cols-1 gap-3 m-4 text-white md:flex md:w-full md:m-20 md:justify-center '>
          <div className='text-[#ca2c92] border-gray-600 border-2 rounded-3xl p-4 font-sm font-myname md:w-[700px] md:p-10 md:text-2xl'>
          ...
          <div className='border-gray-600 border-2 rounded-3xl p-4 font-sm font-myname md:w-[700px] md:p-10 md:text-2xl'>
